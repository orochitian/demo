<template>
  <div class="container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :md="6">
        <el-card class="box-card">
          <div slot="header">
            <span>超差</span>
            <el-tag style="float: right" type="warning" size="small">当月</el-tag>
          </div>
          <div class="body">
      ...
      <el-col :md="6">
        <el-card class="box-card">
          <div slot="header">
            <span>短信</span>
            <el-tag style="float: right" type="danger" size="small">报警</el-tag>
          </div>
          <div class="body">
    ...
    >
      ...
      <el-table-column prop="endDate" label="最后出料时间" width="200"> </el-table-column>
